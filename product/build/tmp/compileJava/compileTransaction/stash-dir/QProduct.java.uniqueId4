...
public class QProduct extends EntityPathBase<Product> {
    ...
    public final EnumPath<com.ojo.mullyuojo.product.application.security.Role> role = createEnum("role", com.ojo.mullyuojo.product.application.security.Role.class);
